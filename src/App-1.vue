  ...
  <div class="wrapper">
    ...
    <div class="icons">
      ...
      <div class="icons__item">
        <img
          ...
          class="icons__item__img"
        />
        <p class="icons__item__desc">家居时间</p>
      </div>
      <div class="icons__item">
        <img
      ...
      <div class="icons__item">
        <img
          ...
          class="icons__item__img"
        />
        <p class="icons__item__desc">大牌搬运</p>
      </div>
      <div class="icons__item">
        <img
    ...
    <div class="nearby">
      ...
      <div class="nearby__item">
        <img
          src="https://soft2176-use.oss-cn-hangzhou.aliyuncs.com/jingdong/icon/shop1.png"
        ...
        <div class="nearby_content">
          ...
          <div class="nearby__content__tags">
            ...
            <span class="nearby__content__tag">起送￥0元</span>
      ...
      <div class="nearby__item">
        <img
          src="https://soft2176-use.oss-cn-hangzhou.aliyuncs.com/jingdong/icon/shop2.png"
          class="nearby__item__img"
        />
        <div class="nearby_content">
          ...
          <div class="nearby__content__highlight">联合利华洗护满10减5</div>
        </div>
      </div>
      <div class="nearby__item">
        <img
